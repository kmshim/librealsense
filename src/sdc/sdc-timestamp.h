...
{
    class sdc_timestamp_reader_from_metadata : public frame_timestamp_reader
    {
    ...
    public:
        sdc_timestamp_reader_from_metadata(std::unique_ptr<frame_timestamp_reader> backup_timestamp_reader);
    ...
    class sdc_timestamp_reader : public frame_timestamp_reader
    {
        static const int pins = 2;
        ...
        mutable std::recursive_mutex _mtx;
    public:
        sdc_timestamp_reader(std::shared_ptr<platform::time_service> ts);
    ...
    class sdc_custom_hid_timestamp_reader : public frame_timestamp_reader
    {
        ...
        mutable std::recursive_mutex _mtx;
    public:
        sdc_custom_hid_timestamp_reader();
